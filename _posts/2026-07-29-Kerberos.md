![Cerberus](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqbOf82WCXrC1YsMl1L-JXPAYo6NRgn3fzfZHbT2HsDg&s)
  ...
  <button type="button" class="btn btn-lg btn-warning">THIS POST IS UNDER CONSTRUCTION</button>
...
[This](https://web.mit.edu/kerberos/dialogue.html) dialogue provides a fictional example of how `kerberos` was built, under a different name of `Charon` (which I have renamed to `Odin` because I hate the spelling of `Charon`). I'll expand upon the example, with (poor) diagrams and rewording. 
